...
<html lang="en">
   ...
   <body>
      ...
      <div class="banner_bg_main">
         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="logo"><a href="index.php"><p style="font-size: 36px;
                        font-weight: 600;
                        color: white;">RT Fashion</p></a></div>
                  </div>
               </div>
            </div>
         </div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                    ...
                                    <button id="pay-button" data-amount="1000">Pay with Khalti</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
      ...
      <!-- <button id="pay-button" data-amount="1000">Pay with Khalti</button> -->
         ...
         <div class="container">
            <div class="footer_logo"><a href="index.php"><p style="font-size: 36px;
               font-weight: 600;
               color: white;">RT Fashion</p></a></div>
            <div class="input_bt">
            ...
            <div class="location_main">Help Line  Number : <a href="#">+977 9824288601</a></div>
         </div>
      </div>
      <!-- footer section end -->
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">© 2020 All Rights Reserved. Design by <a href="https://php.design">Aarti Shah</a></p>
         </div>
      </div>
